...
widget:
- source_sentence: TUBE CU 12MM OD
  sentences:
  - TUBE COPPER 12MM OD
  - BRG BALL DG 6212 2RS
  - BRG/BALL/DG/6306/2RS
- source_sentence: OIL LUBE VG46 210
  sentences:
  - BRG/BALL/DG/6306/2RS
  - BRG BALL DG 6204 2RS
  - OIL/LUBE/VG46/210
- source_sentence: BUSH GUNMETAL 50MM
  sentences:
  - CONTACTOR 3P 18A 415V
  - SLEEVE/GUNMETAL/50MM
  - CONTACTOR,3P,25A,415V
- source_sentence: BRG BALL DG 6206 2RS
  sentences:
  - OIL/LUBE/VG46/210
  - BRG/BALL/DG/6203/2RS
  - OIL LUBRICATING VG46 210
- source_sentence: BRG BALL DG 6212 2RS
  sentences:
  - BRG/BALL/DG/6306/2RS
  - OIL/LUBE/VG46/210
  - CONTACTOR/3P/12A/415V
...
print(similarities)
# tensor([[ 1.0000, -0.0620,  0.0413],
#         [-0.0620,  1.0000,  0.2434],
#         [ 0.0413,  0.2434,  1.0000]])
```
<!--
...
* Approximate statistics based on the first 100 samples:
  ...
  | modality | text                                                                              | text                                                                              |                                                                |
  | details  | <ul><li>min: 7 tokens</li><li>mean: 17.36 tokens</li><li>max: 35 tokens</li></ul> | <ul><li>min: 7 tokens</li><li>mean: 17.87 tokens</li><li>max: 33 tokens</li></ul> | <ul><li>min: 0.0</li><li>mean: 0.22</li><li>max: 1.0</li></ul> |
* Samples:
  | sentence_0                                               | sentence_1                                                | label            |
  |:---------------------------------------------------------|:----------------------------------------------------------|:-----------------|
  | <code>TUBE,SEAMLESS,SS304,6MM,OD</code>                  | <code>TUBE/SMLS/SS304/10MM/OD</code>                      | <code>0.0</code> |
  | <code>BLT HEX MS M12X50 8.8 IS 1367</code>               | <code>BOLT,HEXAGONAL,MILD,STEEL,M14X60,8.8,IS,1367</code> | <code>0.0</code> |
  | <code>BOLT HEXAGONAL MILD STEEL M8X30 8.8 IS 1367</code> | <code>BLT HEX MS M24X120 8.8 IS 1367</code>               | <code>0.0</code> |

  ...
  return (
    <div>
      ...
      <div className="mt-4 md:mt-6">
        ...
        <div className="mt-3 md:mt-4 flex items-start gap-3 rounded-card border border-red-200 bg-red-50 p-3 md:p-4 dark:border-red-900/40 dark:bg-red-950/30">
          <span className="grid h-8 w-8 md:h-9 md:w-9 shrink-0 place-items-center rounded-lg bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-400">
            <Flame size={15} />
          </span>
          <div>
            <p className="text-sm font-semibold text-red-800 dark:text-red-400">{t('herd.hotspot')} <AiThinkingDots /></p>
            ...
            <Link to="/animals?shed=C" className="mt-1.5 md:mt-2 inline-block text-xs font-medium text-red-800 underline dark:text-red-400">
